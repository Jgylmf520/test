window.BMAP_AUTHENTIC_KEY = "H4NTSlpqD0V3jc3AMFtXUlra7IzakOWw";
(function () {
    function aa(a) {
        throw a;
    }
    ...
    x.D.tj = function (a, b) {
        ...
        if (!d)var e = c.HB[b], d = a.currentStyle || (x.ea.la ? a.style : getComputedStyle(a, p)), d = e && e.get ? e.get(a, d) : d[e || b];
    ...
    function Ka(a, b) {
        if (a = x.$(a)) {
            ...
            c.Uu();
            c.R = {Jc: q, kc: 0, ot: 0, rM: 0, c3: 0, fC: q, eF: -1, Ne: []};
    ...
    x.extend(Ka.prototype, {
        ua: function () {
            ...
            var b = this;
            if (a instanceof H) b.ti(a, {noAnimation: o}); else if (Za(a))if (b.Hb === Oa) {
                var c = F.kC[a];
                c && (pt = c.m, b.Vf(pt))
            } else {
                var d = this.JH();
            ...
            a ? this.ls && this.ls.xf === a || (this.zh(this.ls), this.ls = new nb({geotableId: a}), this.Yg(this.ls)) : this.zh(this.ls)
        }, Ub: function () {
            ...
            return {name: this.$g, code: this.as}
        }, rm: function () {
            this.P.$n();
            return this.P
    ...
    function sb(a) {
        var b = {duration: 1E3, Ic: 30, Io: 0, hc: tb.vM, At: s()};
        this.Zf = [];
    ...
    $a.Ei.lE({mZ: 18, an: 0.1, max: 1});
    z.fq = {pG: "#83a1ff", hq: "#808080"};
    function Ob(a, b, c) {
        b.Mm || (b.Mm = [], b.handle = {});
    ...
    "2" !== z.Vp && (function (a, b, c) {
        (function (a, b, c) {
            ...
            var C = c.alog;
            if (!C || !C.Ho) {
                var A = b.all && a.attachEvent, B = C && C.BE || +new Date, D = a.f3 || (+new Date).toString(36) + Math.random().toString(36).substr(2, 3), E = 0, J = {}, O = function (a) {
                ...
                w.prototype.send = function (a, b) {
                    var c = v({ts: i().toString(36), t: a, sid: D}, this.Js);
                ...
                w.prototype.set = function (a, b) {
                    if ("string" == typeof a) "protocolParameter" == a && (b = v({
                        oy: p,
                        bF: p
                    }, b)), this.Js[a] = b; else if ("object" == typeof a)for (var c in a)this.set(c, a[c])
                };
    ...
    x.extend(ib.prototype, {
        ...
        }, ha: t("Kb"), Tt: ba("Vg"), $D: t("Vg"), setUserData: ba("uJ"), getUserData: t("uJ")
    });
    function Sb() {
        this.C = p;
        this.Lb = "control";
    ...
    x.extend(hb.prototype, {
        Jm: function (a, b) {
            ...
            I.load("coordtrans", function () {
                var a = hc.UD(c.fj || "bj", d), a = new Q(a.x, a.y);
                b && b(a)
            }, o)
        }, pointToLngLatFor3D: function (a, b) {
            var c = this, d = new H(a.x, a.y);
            I.load("coordtrans", function () {
                var a = hc.TD(c.fj || "bj", d), a = new H(a.lng, a.lat), a = R.Eb(a);
                b && b(a)
            }, o)
        }, FQ: function (a, b) {
    ...
    x.extend(qc.prototype, {
        setWidth: function (a) {
            ...
            return this.z.title
        }, bd: ba("content"), uk: t("content"), Qt: function (a) {
            this.z.KE = a + ""
        }, fe: s(), Fs: function () {
            this.z.Fs = o
    ...
    x.extend(Dc.prototype, {
        qa: function () {
            ...
            var d = this.map, e = d.oa(), f = d.Ka, g = d.lc, i = e.Bc(f), k = this.oL(), l = k[0], m = k[1], n = k[2], u = k[3], v = k[4], c = "undefined" != typeof c ? c : 0, e = e.k.Ob, k = d.ba.replace(/^TANGRAM_/, "");
            ...
            var a = this.map, b = a.oa(), c = b.fE(a.Ka), d = a.lc, e = Math.ceil(d.lng / c), f = Math.ceil(d.lat / c), b = b.k.Ob, c = [e, f, (d.lng - e * c) / c * b, (d.lat - f * c) / c * b];
            return [c[0] - Math.ceil((a.width / 2 - c[2]) / b), c[1] - Math.ceil((a.height / 2 - c[3]) / b), c[0] + Math.ceil((a.width / 2 + c[2]) / b), c[1] + Math.ceil((a.height / 2 + c[3]) / b), c]
        }, m_: function (a, b, c, d) {
            var e = this;
            e.u1 = b;
            var f = this.map.oa(), g = e.aE(a, c), i = f.k.Ob, b = [a[0] * i + b[0], (-1 - a[1]) * i + b[1]], k = this.wg[g];
            ...
            for (var g = 0; g < c; g++) {
                ...
                if (!i.bI && !(i.mp && !this.map.Ub() || i.lM && this.map.Ub())) {
                    ...
                    var u = e.Bc(m), k = e.fE(m), l = Math.ceil(f.lng / k), v = Math.ceil(f.lat / k), w = e.k.Ob, k = [l, v, (f.lng - l * k) / k * w, (f.lat - v * k) / k * w], n = k[0] - Math.ceil((d.width / 2 - k[2]) / w), l = k[1] - Math.ceil((d.height / 2 - k[3]) / w), v = k[0] + Math.ceil((d.width / 2 + k[2]) / w), y = 0;
                    e === Oa && 15 == d.fa() && (y = 1);
                    e = k[1] + Math.ceil((d.height / 2 + k[3]) / w) + y;
                    this.UJ = new H(f.lng, f.lat);
                    var C = this.wg, w = -this.UJ.lng / u, y = this.UJ.lat / u, u = [Math.ceil(w), Math.ceil(y)], f = d.fa(), A;
                    for (A in C) {
                        var B = C[A], D = B.info;
            ...
            var b = this.map.oa();
            if (!this.map.Ub() && (a ? this.map.K.u_ = a : a = this.map.K.u_, a))for (var c = p, c = "2" == z.Vp ? [z.url.proto + z.url.domain.main_domain_cdn.other[0] + "/"] : [z.url.proto + z.url.domain.main_domain_cdn.baidu[0] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[1] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[2] + "/"], d = 0, e; e = this.Km[d]; d++)if (e.h_ == o) {
                b.k.Zb = 18;
                e.getTilesUrl = function (b, d) {
                    var e = b.x, e = this.map.bb.Aw(e, d).Iw, k = b.y, l = 1;
                    this.map.Ix() && (l = 2);
                    l = "customimage/tile?&x=" + e + "&y=" + k + "&z=" + d + "&udt=20170204&scale=" + l;
    ...
    x.extend(Ec.prototype, {
        qa: function (a, b) {
            ...
            delete this.Pb
        }, nt: t("T_"), getTilesUrl: function (a, b) {
    ...
    nb.prototype.getTilesUrl = function (a, b) {
        var c = a.x, d = a.y, e = this.oc, c = Oc[Math.abs(c + d) % Oc.length] + "/image?grids=" + c + "_" + d + "_" + b + "&q=" + e.Wm + "&tags=" + e.gu + "&filter=" + e.filter + "&sortby=" + e.Ky + "&ak=" + this.oc.Sl + "&age=" + e.vw + "&page_size=" + e.tN + "&format=" + e.C_;
    ...
    Vc.getTilesUrl = function (a, b, c) {
        ...
        return (Tc[Math.abs(d + a) % Tc.length] + "?qt=tile&x=" + (d + "").replace(/-/gi, "M") + "&y=" + (a + "").replace(/-/gi, "M") + "&z=" + b + "&styles=" + c + "&scaler=" + e + (6 == x.ea.la ? "&color_dep=32&colors=50" : "") + "&udt=20170204").replace(/-(\d+)/gi, "M$1")
    };
    ...
    var Bd = Ad.prototype;
    S(Bd, {getPoint: Bd.tm, getLocation: Bd.Ts});
    ...
    x.extend(Hd.prototype, {
        Qi: s(), show: s(), U: s(), AF: function (a) {
            this.oc.types = a
        }, gn: function (a) {
            this.zd.src = a
        }, search: ba("aj"), Ay: ba("YH")
    });
    var Sa;
    ...
    z.Sm(function (a) {
        "flashRender" !== a.Zq() && new bc(a, {Of: "api"})
    });
    x.extend(bc.prototype, {
        ca: function () {
            function a(a) {
    ...
    var ge = be ? "-" + be.toLowerCase() + "-" : "", ie = he("transform"), je = he("transitionProperty"), ke = he("transitionDuration"), le = he("transformOrigin"), ne = he("transitionTimingFunction"), pe = he("transitionDelay"), yd = /android/gi.test(navigator.appVersion), qe = /iphone|ipad/gi.test(navigator.appVersion), re = /hp-tablet/gi.test(navigator.appVersion), se = he("perspective") in ae, te = "ontouchstart" in window && !re, ue = be !== q, ve = he("transition") in ae, we = "onorientationchange" in window ? "orientationchange" : "resize", xe = te ? "touchstart" : "mousedown", ye = te ? "touchmove" : "mousemove", ze = te ? "touchend" : "mouseup", Ae = te ? "touchcancel" : "mouseup", Be = be === q ? q : {
        ...
        }, De = window.cancelRequestAnimationFrame || window.C4 || window.webkitCancelRequestAnimationFrame || window.mozCancelRequestAnimationFrame || window.oCancelRequestAnimationFrame || window.msCancelRequestAnimationFrame || clearTimeout, Ee = se ? " translateZ(0)" : "";
    ...
    Fe.prototype = {
        ...
        bv: function (a) {
            if (!(te && 0 !== a.touches.length)) {
                ...
                if (b.Wk) d = b.scale * b.op, d = Math.max(b.options.Vk, d), d = Math.min(b.options.Yp, d), b.op = d / b.scale, b.scale = d, b.x = b.gy - b.gy * b.op + b.x, b.y = b.hy - b.hy * b.op + b.y, b.Nb.style[ke] = "200ms", b.Nb.style[ie] = "translate(" + b.x + "px," + b.y + "px) scale(" + b.scale + ")" + Ee, b.Wk = q, b.refresh(), b.options.up && b.options.up.call(b, a); else {
                    if (b.rh) {
    ...
    x.extend(Ge.prototype, {
        Lk: function (a) {
            ...
            if (!this.Li) {
                ...
                new Fe(a, {Bo: q, Yx: o, li: q, Bi: q, vn: q, GE: o, Ew: o, Cx: o});
            ...
            if (this.Li) a = this.lL(this.Oi), this.rQ.innerHTML = a; else {
                var a = this.lL(this.Oi), b = K("ul"), c = this;
                ...
                x.M(d, "mouseover", function () {
                    ...
                    new sb({
                        Ic: 60, hc: tb.Es, duration: 300, ua: function (c) {
            ...
            this.Pc = G() ? new Fe(this.gk, {Bo: q, Yx: o, li: q, Bi: q, vn: q, GE: o, Ew: o, Cx: o}) : new Ke(this.gk)
        }, U: function () {
    ...
    Ke.prototype = {
        qa: function () {
            ...
            new sb({
                Ic: 60, hc: tb.Es, duration: 300, ua: function (d) {
    ...
    var Me = R.prototype;
    S(Me, {lngLatToPoint: Me.nh, pointToLngLat: Me.vi});
    var Ne = hb.prototype;
    S(Ne, {lngLatToPoint: Ne.nh, pointToLngLat: Ne.vi});
    var Oe = fb.prototype;
    S(Oe, {
        equals: Oe.mb,
        containsPoint: Oe.ds,
    ...
    var $e = ib.prototype;
    S($e, {getPosition: $e.ha, setPosition: $e.sa, getText: $e.$D, setText: $e.Tt});
    ...
    var ff = Ec.prototype;
    S(ff, {getMapType: ff.oa, getCopyright: ff.om, isTransparentPng: ff.nt});
    var gf = cc.prototype;
    ...
    sd = rd.prototype;
    S(sd, {setPolicy: sd.St, toString: sd.toString, setPageCapacity: sd.Kp});
    S(window, {
